...
You can also enter integers in other bases like binary: `0b11010100`, octal: `0o4377`, or hexadecimal: `0xB1663F`
...
- `fmtstring(fmt, ...)` roughly implements the functionality of the MUF primitive `fmtstring`.  The format string is similar to C's printf function. For full details, see the documentation for the `fmtstring` MUF primitive.
